...
//the func chack the input, and then save the reserve in the database
function FuncReserve() {
	//info of the reserve from input fildes
...
//every change in those fields is monitored and exect the following checks
...
//check if the user tried to reserve a spot in the disabled lot, and also fill the checking box
...
function FuncCheckout() 
{
	...
	//if there is a prob with the input
	if(alertMsg != ''){
		alert (alertMsg);
	}
	else{
...
//change the page to admin if pass was correct
function adminPage() {
...
//change the page to student reserve
